DELETE FROM account_service.fixed_deposit_types WHERE code LIKE 'FD_JAY_%' OR code LIKE 'FD_SIY_%' OR code LIKE 'FD_YAL_%' OR code LIKE 'FD_JAN_%' OR code LIKE 'FD_KOT_%' OR code LIKE 'FD_ROO_%';
