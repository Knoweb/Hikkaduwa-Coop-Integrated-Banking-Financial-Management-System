...
import com.hmcs.pawning.service.AccountService;
...
public class MemberController {
    ...
    public ResponseEntity<?> processDeposit(@RequestBody com.hmcs.pawning.dto.TransactionRequest request) {
        try {
            Long branchId = getCurrentBranchId();
    ...
    public ResponseEntity<?> processWithdraw(@RequestBody com.hmcs.pawning.dto.TransactionRequest request) {
        try {
            Long branchId = getCurrentBranchId();
