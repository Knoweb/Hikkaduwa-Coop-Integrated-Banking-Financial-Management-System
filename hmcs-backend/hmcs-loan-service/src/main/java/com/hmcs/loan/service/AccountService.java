...
import com.hmcs.loan.repository.MemberRepository;
import com.hmcs.loan.repository.SavingsAccountRepository;
...
public class AccountService {
    ...
    @Transactional
    public SavingsAccount processDeposit(com.hmcs.loan.dto.TransactionRequest request, Long branchId) {
    ...
    @Transactional
    public SavingsAccount processWithdraw(com.hmcs.loan.dto.TransactionRequest request, Long branchId) {
        SavingsAccount account = savingsAccountRepository.findByAccountNumberAndBranchId(request.getAccountNumber(), branchId)
                .orElseThrow(() -> new RuntimeException("Account not found in this branch"));
