package com.hmcs.reporting.service;
...
public class AccountService {
    ...
    @Transactional
    public SavingsAccount processDeposit(com.hmcs.account.dto.TransactionRequest request, Long branchId) {
    ...
    @Transactional
    public SavingsAccount processWithdraw(com.hmcs.account.dto.TransactionRequest request, Long branchId) {
        SavingsAccount account = savingsAccountRepository.findByAccountNumberAndBranchId(request.getAccountNumber(), branchId)
                .orElseThrow(() -> new RuntimeException("Account not found in this branch"));
