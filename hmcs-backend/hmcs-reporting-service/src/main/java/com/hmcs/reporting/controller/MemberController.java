package com.hmcs.reporting.controller;
...
public class MemberController {
    ...
    public ResponseEntity<?> processDeposit(@RequestBody com.hmcs.account.dto.TransactionRequest request) {
        try {
            Long branchId = getCurrentBranchId();
    ...
    public ResponseEntity<?> processWithdraw(@RequestBody com.hmcs.account.dto.TransactionRequest request) {
        try {
            Long branchId = getCurrentBranchId();
