        ...
        <div className="px-6 py-5 bg-gradient-to-r from-emerald-700 to-emerald-900 text-white flex items-center justify-between shrink-0">
          <div>
            <h2 className="text-xl font-bold flex items-center gap-2">
              <Banknote size={20} /> {t(`උකස් අත්තිකාරම් නිකුත් කිරීම`)}</h2>
        ...
        <div className="p-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
              <p className="text-xs text-slate-500 font-bold mb-1">{t(`සාමාජිකයා`)}</p>
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-1">{t(`නිකුත් කරන උකස් අත්තිකාරම (Advance Amount) *`)}</label>
              <input 
                type="number" 
                value={advanceAmount} 
