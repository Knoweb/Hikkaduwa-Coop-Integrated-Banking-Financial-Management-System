...
const translations: Translations = {
  ...
  'Personal Information': { en: 'Personal Information', si: 'පුද්ගලික තොරතුරු' },
  'Full Name': { en: 'Full Name', si: 'සම්පූර්ණ නම' },
  'Name with Initials': { en: 'Name with Initials', si: 'මුලකුරු සමඟ නම' },
  'Name in Sinhala (Optional)': { en: 'Name in Sinhala (Optional)', si: 'සිංහලෙන් නම (විකල්ප)' },
  'Date of Birth': { en: 'Date of Birth', si: 'උපන් දිනය' },
  'Gender': { en: 'Gender', si: 'ස්ත්‍රී පුරුෂ භාවය' },
  'Male': { en: 'Male', si: 'පුරුෂ' },
  'Female': { en: 'Female', si: 'ස්ත්‍රී' },
  'Marital Status': { en: 'Marital Status', si: 'විවාහක/අවිවාහක බව' },
  'Married': { en: 'Married', si: 'විවාහක' },
  'Unmarried': { en: 'Unmarried', si: 'අවිවාහක' },
  'Address': { en: 'Address', si: 'ලිපිනය' },
  'Province': { en: 'Province', si: 'පළාත' },
  'Contact Number': { en: 'Contact Number', si: 'දුරකථන අංකය' },
  'Photograph': { en: 'Photograph', si: 'ඡායාරූපය' },
  'Registration Type': { en: 'Registration Type', si: 'ලියාපදිංචි වර්ගය' },
  ...
  // Account Types
  'Normal Savings (Samanaya 01)': { en: 'Normal Savings (Samanaya 01)', si: 'සාමාන්‍ය 01' },
  'Janasetha': { en: 'Janasetha', si: 'ජනසෙත' },
  'Dhana Yojana': { en: 'Dhana Yojana', si: 'ධන යෝජනා' },
  'Vandana': { en: 'Vandana', si: 'වන්දනා' },
  'Arunalu (Children)': { en: 'Arunalu (Children)', si: 'අරුණලු' },
  'Ranthilina (Children)': { en: 'Ranthilina (Children)', si: 'රන්තිලින' },
