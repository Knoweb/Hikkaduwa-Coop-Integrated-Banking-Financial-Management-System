...
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot2 = React10.useCallback(() => defaultMatches, [defaultMatches]);
...
function useReducedMotionMediaQueryOld(enabled) {
  const [queryState, setQueryState] = React30.useState(() => ({
    enabled,
...
var maybeReactUseSyncExternalStore3 = safeReact4.useSyncExternalStore;
function useReducedMotionMediaQueryNew(enabled) {
  ...
  const [getSnapshot, subscribe2] = React30.useMemo(() => {
  ...
  return maybeReactUseSyncExternalStore3(subscribe2, getSnapshot, getServerSnapshot);
}
var useReducedMotionMediaQuery = maybeReactUseSyncExternalStore3 !== void 0 ? useReducedMotionMediaQueryNew : useReducedMotionMediaQueryOld;
...
@mui/system/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-OZBRLB67.js.map
