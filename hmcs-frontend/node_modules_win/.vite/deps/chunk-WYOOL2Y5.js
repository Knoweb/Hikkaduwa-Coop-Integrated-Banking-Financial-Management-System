...
// node_modules/@mui/material/Snackbar/Snackbar.mjs
var React8 = __toESM(require_react(), 1);
var import_prop_types6 = __toESM(require_prop_types(), 1);

// node_modules/@mui/material/Snackbar/useSnackbar.mjs
...
// node_modules/@mui/material/ClickAwayListener/ClickAwayListener.mjs
...
function Transition(props) {
  ...
  const parentGroup = React5.useContext(TransitionGroupContext_default);
  ...
  const shouldAppearOnMountRef = React5.useRef(inProp && shouldEnterOnMount);
  const mountedRef = React5.useRef(false);
  const nextCallbackRef = React5.useRef(null);
  const lastFiredStatusRef = React5.useRef(status);
  const isAppearingRef = React5.useRef(false);
  const transitionReduceMotionRef = React5.useRef(reduceMotion);
  ...
  const cancelPendingCallback = React5.useCallback(() => {
    if (nextCallbackRef.current !== null) {
      nextCallbackRef.current.cancel();
      nextCallbackRef.current = null;
    }
  }, []);
  const makeCallback = React5.useCallback((handler) => {
    let active = true;
    const wrapped = () => {
      if (active) {
        active = false;
  ...
  const scheduleTransitionEnd = React5.useCallback((nextStatus, currentStatus) => {
    var _a, _b;
    let timeoutId;
    const clearTimer = () => {
      if (timeoutId !== void 0) {
  ...
  const performEnter = React5.useCallback((mounting) => {
    var _a;
  ...
  const performExit = React5.useCallback(() => {
    var _a;
    const current = propsRef.current;
    if (!current.exit) {
      statusRef.current = "exited";
  ...
  const updateStatus = React5.useCallback((mounting, nextStatus) => {
...
true ? Transition.propTypes = {
   ...
   * @ignore
   */
  getAutoTimeout: import_prop_types3.default.func,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  reduceMotion: import_prop_types3.default.bool,
  /**
   * @ignore
   */
...
var Grow = React6.forwardRef(function Grow2(props, ref) {
  ...
  const autoTimeout = React6.useRef(null);
...
true ? Grow.propTypes = {
   ...
   * @default false
   */
  disablePrefersReducedMotion: import_prop_types4.default.bool,
  /**
...
// node_modules/@mui/material/SnackbarContent/SnackbarContent.mjs
var React7 = __toESM(require_react(), 1);
var import_prop_types5 = __toESM(require_prop_types(), 1);

// node_modules/@mui/material/SnackbarContent/snackbarContentClasses.mjs
...
var SnackbarContent = React7.forwardRef(function SnackbarContent2(inProps, ref) {
...
// node_modules/@mui/material/Snackbar/snackbarClasses.mjs
...
var Snackbar = React8.forwardRef(function Snackbar2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSnackbar"
  });
  ...
  return (0, import_jsx_runtime4.jsx)(ClickAwaySlot, {
    ...
    children: (0, import_jsx_runtime4.jsx)(Root, {
      ...
      children: (0, import_jsx_runtime4.jsx)(TransitionSlot, {
        ...transitionProps,
        children: children || (0, import_jsx_runtime4.jsx)(ContentSlot, {
          ...contentSlotProps
        })
      })
    })
...
true ? Snackbar.propTypes = {
  ...
  anchorOrigin: import_prop_types6.default.shape({
    horizontal: import_prop_types6.default.oneOf(["center", "left", "right"]).isRequired,
   ...
   * @default null
   */
  autoHideDuration: import_prop_types6.default.number,
  /**
   ...
   * @default false
   */
  disableWindowBlurListener: import_prop_types6.default.bool,
  /**
   ...
   * The message to display.
   */
  message: import_prop_types6.default.node,
  /**
   * @ignore
   */
   ...
   */
  resumeHideDuration: import_prop_types6.default.number,
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types6.default.shape({
    clickAwayListener: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object]),
  ...
  slots: import_prop_types6.default.shape({
    clickAwayListener: import_prop_types6.default.elementType,
...
//# sourceMappingURL=chunk-WYOOL2Y5.js.map
