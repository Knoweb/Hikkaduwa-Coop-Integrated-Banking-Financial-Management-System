...
// node_modules/@mui/material/utils/createChainedFunction.mjs
...
// node_modules/@mui/utils/deprecatedPropType/deprecatedPropType.mjs
...
// node_modules/@mui/material/utils/deprecatedPropType.mjs
...
// node_modules/@mui/utils/requirePropFactory/requirePropFactory.mjs
...
// node_modules/@mui/material/utils/requirePropFactory.mjs
...
// node_modules/@mui/material/utils/setRef.mjs
...
// node_modules/@mui/material/utils/index.mjs
...
function useButtonBase(parameters) {
  ...
  const hasNativeKeyboardActivation = React6.useCallback(() => {
    const root = rootRef.current;
    if (root == null) {
      return nativeButton;
    }
  ...
  const getButtonProps = React6.useCallback((externalProps = EMPTY) => {
    const {
...
function Ripple(props) {
  ...
  const exitTimerStartedRef = React8.useRef(false);
  const onExitedRef = React8.useRef(onExited);
...
var TouchRipple = React9.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [rippleState, setRippleState] = React9.useState({
    items: EMPTY_ARRAY,
    order: EMPTY_ARRAY
  });
  ...
  const mountedRef = React9.useRef(false);
  useOnMount(() => {
  ...
  const handleExited = useEventCallback_default2((key) => {
  ...
  const startCommit = useEventCallback_default2((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
  ...
  const start = useEventCallback_default2((event = EMPTY_OBJ, options = EMPTY_OBJ, cb = NOOP) => {
    const {
  ...
  const pulsate = useEventCallback_default2(() => {
    start(EMPTY_OBJ, {
      pulsate: true
    });
  });
  const stop = useEventCallback_default2((event, cb) => {
    startTimer.clear();
  ...
  return (0, import_jsx_runtime4.jsx)(TouchRippleRoot, {
    ...
    ref: container,
    ...other,
    children: orderedRipples.map((ripple) => (0, import_jsx_runtime4.jsx)(TouchRippleRipple, {
      classes: {
...
true ? ButtonBase.propTypes = {
   ...
   */
  nativeButton: import_prop_types6.default.bool,
  /**
   * @ignore
   */
...
//# sourceMappingURL=chunk-AFJ6NBA5.js.map
